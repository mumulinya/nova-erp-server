...
CREATE TABLE `logistics_order` (
  ...
  `total_cost` decimal(10,2) DEFAULT '0.00' COMMENT '运输总费用(元)',
...
CREATE TABLE `logistics_vehicle` (
  ...
  `price_per_day` decimal(10,2) DEFAULT '0.00' COMMENT '每日运费（元/天）',
  `fuel_cost_per_km` decimal(10,2) DEFAULT '0.00' COMMENT '每公里油费（元/公里）',

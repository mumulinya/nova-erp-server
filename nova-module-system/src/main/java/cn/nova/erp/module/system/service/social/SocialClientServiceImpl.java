...
import cn.nova.erp.framework.common.util.cache.CacheUtils;
...
import cn.nova.erp.module.system.dal.mysql.social.SocialClientMapper;
import cn.nova.erp.module.system.dal.redis.RedisKeyConstants;
import cn.nova.erp.module.system.enums.social.SocialTypeEnum;
import cn.nova.erp.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.nova.erp.framework.common.util.collection.MapUtils.findAndThen;
import static cn.nova.erp.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.nova.erp.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;

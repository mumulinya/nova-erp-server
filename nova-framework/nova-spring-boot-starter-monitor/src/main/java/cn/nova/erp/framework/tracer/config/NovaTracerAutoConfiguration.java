...
import cn.nova.erp.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "nova.tracer", value = "enable", matchIfMissing = true)
public class NovaTracerAutoConfiguration {

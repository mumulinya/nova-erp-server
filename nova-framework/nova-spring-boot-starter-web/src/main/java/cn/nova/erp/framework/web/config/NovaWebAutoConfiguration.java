package cn.nova.erp.framework.web.config;
...
import cn.nova.erp.framework.web.core.filter.CacheRequestBodyFilter;
import cn.nova.erp.framework.web.core.filter.DemoFilter;
import cn.nova.erp.framework.web.core.handler.GlobalExceptionHandler;
import cn.nova.erp.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class NovaWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "nova.demo", havingValue = "true")
